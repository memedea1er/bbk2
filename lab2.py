...
def main():
    ...
    hl_values, hl_opt = hodge_lehman_criterion(loss_matrix, n_strategies, n_states, 0.5, probabilities)
    ...
    print(f"Оптимальная стратегия: {strategies[savage_opt]} (минимальные максимальные сожаления)")
